...
var (
	productDBTypes = map[string]string{`ID`: `bigint`, `Title`: `varchar`, `Handle`: `varchar`, `ProductType`: `varchar`, `Vendor`: `varchar`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`, `Status`: `int`}
	_              = bytes.MinRead
)
