...
type Collection struct {
	...
	Handle         null.String `boil:"handle" json:"handle,omitempty" toml:"handle" yaml:"handle,omitempty"`
	PublishedAt    null.Time   `boil:"published_at" json:"published_at,omitempty" toml:"published_at" yaml:"published_at,omitempty"`
	PublishedScope null.String `boil:"published_scope" json:"published_scope,omitempty" toml:"published_scope" yaml:"published_scope,omitempty"`
	SortOrder      null.String `boil:"sort_order" json:"sort_order,omitempty" toml:"sort_order" yaml:"sort_order,omitempty"`
...
var CollectionWhere = struct {
	...
	Handle         whereHelpernull_String
	PublishedAt    whereHelpernull_Time
	PublishedScope whereHelpernull_String
	SortOrder      whereHelpernull_String
	...
	Handle:         whereHelpernull_String{field: "`collection`.`handle`"},
	PublishedAt:    whereHelpernull_Time{field: "`collection`.`published_at`"},
	PublishedScope: whereHelpernull_String{field: "`collection`.`published_scope`"},
	SortOrder:      whereHelpernull_String{field: "`collection`.`sort_order`"},
