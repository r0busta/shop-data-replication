...
var InventoryLevelWhere = struct {
	...
	Available:       whereHelperint{field: "`inventory_level`.`available`"},
...
type (
	...
	// This should almost always be used instead of []InventoryLevel.
...
func FindInventoryLevel(ctx context.Context, exec boil.ContextExecutor, inventoryItemID int64, locationID int64, selectCols ...string) (*InventoryLevel, error) {
	...
	if err = inventoryLevelObj.doAfterSelectHooks(ctx, exec); err != nil {
		return inventoryLevelObj, err
	}
