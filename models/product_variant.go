...
type ProductVariant struct {
	...
	InventoryManagement null.String       `boil:"inventory_management" json:"inventory_management,omitempty" toml:"inventory_management" yaml:"inventory_management,omitempty"`
	InventoryPolicy     null.String       `boil:"inventory_policy" json:"inventory_policy,omitempty" toml:"inventory_policy" yaml:"inventory_policy,omitempty"`
	InventoryQuantity   null.Int          `boil:"inventory_quantity" json:"inventory_quantity,omitempty" toml:"inventory_quantity" yaml:"inventory_quantity,omitempty"`
	...
	Taxable             null.Bool         `boil:"taxable" json:"taxable,omitempty" toml:"taxable" yaml:"taxable,omitempty"`
...
var ProductVariantWhere = struct {
	...
	InventoryManagement whereHelpernull_String
	InventoryPolicy     whereHelpernull_String
	InventoryQuantity   whereHelpernull_Int
	Position            whereHelpernull_Int16
	Price               whereHelpertypes_NullDecimal
	Sku                 whereHelpernull_String
	Taxable             whereHelpernull_Bool
	...
	ProductID:           whereHelpernull_Int64{field: "`product_variant`.`product_id`"},
	...
	InventoryManagement: whereHelpernull_String{field: "`product_variant`.`inventory_management`"},
	InventoryPolicy:     whereHelpernull_String{field: "`product_variant`.`inventory_policy`"},
	InventoryQuantity:   whereHelpernull_Int{field: "`product_variant`.`inventory_quantity`"},
	Position:            whereHelpernull_Int16{field: "`product_variant`.`position`"},
	Price:               whereHelpertypes_NullDecimal{field: "`product_variant`.`price`"},
	Sku:                 whereHelpernull_String{field: "`product_variant`.`sku`"},
	Taxable:             whereHelpernull_Bool{field: "`product_variant`.`taxable`"},
	Title:               whereHelpernull_String{field: "`product_variant`.`title`"},
	Weight:              whereHelpernull_Float64{field: "`product_variant`.`weight`"},
	WeightUnit:          whereHelpernull_String{field: "`product_variant`.`weight_unit`"},
...
type (
	...
	// This should generally be used opposed to []ProductVariant.
